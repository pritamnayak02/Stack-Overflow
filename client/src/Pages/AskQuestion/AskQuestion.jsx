                ...
                <form onSubmit ={handleSubmit}>
                    <div className="ask-form-container">
                        <label htmlFor="ask-ques-title">
                            <h4>Title</h4>
                            <p>Be specific and imagine you'are asking a question to another persion</p>
                        ...
                        <label htmlFor="ask-ques-tags">
                            ...
                            <input type="text" id="ask-question-tags" onChange={(e) => {setQuestionTags(e.target.value.split(" "))}} placeholder='e.g. (xml typscript wordpress)' />
                        </label>
                    </div>
